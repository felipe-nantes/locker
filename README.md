...
MQTT_URL=mqtts://SEU_HOST_HIVEMQ:8883
MQTT_USERNAME=SEU_USUARIO
MQTT_PASSWORD=SUA_SENHA
MQTT_TOPIC_ROOT=nexlock
MQTT_CLIENT_ID=nexlock-backend-demo
HUB_OFFLINE_GRACE_MS=15000
```
...
// No ESP32 físico:
WIFI_SSID = "Nome da rede real"
WIFI_PASSWORD = "Senha da rede real"
```
